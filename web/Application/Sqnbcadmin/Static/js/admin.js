...
/**
 * 上传附件 by wangzhiliang 2016-11-02
 * btnUpload: 上传按钮的ID
...
function ajaxUploadField(btnUpload, inputImg, savePath, item){
    ...
    new AjaxUpload($(btnUpload), {
        ...
        dataType : 'text',
        onSubmit : function(file, ext){
            if(!(ext && /^(jpg|png|gif|jpeg|doc|docx|ppt|pptx|pps|xls|xlsx|pot|vsd|rtf|wps|et|dps|pdf|txt|mp3|3gp|wmv|avi|mp4)$/.test(ext.toLowerCase()))){
