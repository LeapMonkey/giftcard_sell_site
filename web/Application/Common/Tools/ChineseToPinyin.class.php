...
class ChineseToPinyin {
	...
	public function __construct(){
		if( empty($this->ChineseCharacters) ){
			$this->ChineseCharacters = file_get_contents('Public/pinyinlib/ChineseCharacters.dat');
		}
	}
	...
	*/	
	...
	/**
	 * 返回全拼音与首个拼音字符的字符串组合,以'-'进行连接
	 * @param $input_char
	 * @return string
	 */
	public function getAllPinyi($input_char){
		$pinyin = $this->TransformWithoutTone($input_char);
		$firstLetter = strtolower($this->TransformUcwords($input_char));
