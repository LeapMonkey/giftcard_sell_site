...
//------------------------------------------------------用户体系    
    ...
    public function __construct($options) {
        $this->client_id = isset ( $options ['client_id'] ) ? $options ['client_id'] : C('EMCHAT')['client_id'];
        $this->client_secret = isset ( $options ['client_secret'] ) ? $options ['client_secret'] : C('EMCHAT')['client_secret'];
        $this->org_name = isset ( $options ['org_name'] ) ? $options ['org_name'] : C('EMCHAT')['org_name'];
        $this->app_name = isset ( $options ['app_name'] ) ? $options ['app_name'] : C('EMCHAT')['app_name'];
